...
(function(window, undefined){
	...
	WriterToJSON.prototype.SerParagraph = function(oPara, aComplexFieldsToSave, oMapCommentsInfo, oMapBookmarksInfo)
	{
		...
		// Revisions
		var aChanges = oLogicDocument.TrackRevisionsManager.GetElementChanges(oPara.Id);
	...
	WriterToJSON.prototype.SerBullet = function(oBullet)
	{
		...
		return {
			bulletColor: {
				...
				color: this.SerColor(oBullet.bulletColor.UniColor)
			},
			bulletSize: {
				type: sBulleSizeType,
	...
	WriterToJSON.prototype.SerShape = function(oShapeObject, aComplexFieldsToSave)
	{
		if (!oShapeObject)
			return oShapeObject;

		var oContentHolder = null;
		if (oShapeObject.textBoxContent)
			oContentHolder = oShapeObject.textBoxContent;
		else if (oShapeObject.txBody)
			oContentHolder = oShapeObject.txBody.content;
		...
		var oShape = {
			...
			content:     oContentHolder ? this.SerDocContent(oContentHolder, aComplexFieldsToSave) : null,
			type:        "shape",
		}
	...
	ReaderFromJSON.prototype.ChartSpaceFromJSON = function(oParsedChart, oParentDrawing)
	{
		...
		oChartSpace.clrMapOvr = oChartSpace.clrMapOvr; /// ???
