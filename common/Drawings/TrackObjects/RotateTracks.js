...
function RotateTrackShapeImage(originalObject)
{
    ...
    this.trackEnd = function()
    {
        ...
        if(this.originalObject.isObjectInSmartArt()) {
            ...
            var originalPosX = this.originalObject.spPr.xfrm.offX;
            var originalPosY = this.originalObject.spPr.xfrm.offY;
            ...
            var posX = this.originalObject.spPr.xfrm.offX;
            var posY = this.originalObject.spPr.xfrm.offY;
