...
// Import
    ...
    CChartDataRefs.prototype.collectWorksheetsRefs = function(aWSNames) {
        //todo
    };
    ...
    CSeriesBase.prototype.setParent = function(pr) {
        History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_CommonChartFormat_SetParent, this.parent, pr));
        this.parent = pr;
    };
    ...
    CSeriesBase.prototype.setVisible = function(bVal) {
        ...
        if(bVal) {
            ...
            if(this.isVisible()) {
                this.parent.removeSeriesInternal(this.getSeriesArrayIdx(this));
    ...
    CPlotArea.prototype = Object.create(AscFormat.CBaseObject.prototype);
    CPlotArea.prototype.constructor = CPlotArea;
    ...
    CChartBase.prototype.tryCreateNewChartFormSeries = function(oSeries, nType, bIsSecondaryAxis) {
        ...
        if(this.parent.isPieType(nType) || this.parent.isDoughnutType(nType)) {
            ...
            oChartForAxes = this.parent.getChartWithSuitableAxes(nType, bIsSecondaryAxis);
            if(oChartForAxes) {
    ...
    CAxisBase.prototype.constructor = CAxisBase;
    CAxisBase.prototype.getChartSpace = function() {
        var oPlotArea = this.parent;
        if(!oPlotArea) {
            return null;
        }
        var oChart = oPlotArea.parent;
        if(!oChart) {
            return null;
        }
        return oChart.parent;
    };
    ...
    CAxisBase.prototype.setParent = function(pr) {
        History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_CommonChartFormat_SetParent, this.parent, pr));
        this.parent = pr;
    };
    ...
    CAxisBase.prototype.createDuplicate = function() {
    ...
    CCatAx.prototype = Object.create(CAxisBase.prototype);
    CCatAx.prototype.constructor = CCatAx;
    ...
    CDateAx.prototype = Object.create(CAxisBase.prototype);
    CDateAx.prototype.constructor = CDateAx;
    ...
    CSerAx.prototype = Object.create(CAxisBase.prototype);
    CSerAx.prototype.constructor = CSerAx;
    ...
    CValAx.prototype = Object.create(CAxisBase.prototype);
    CValAx.prototype.constructor = CValAx;
    ...
    CValAx.prototype.getSourceFormatCode = function() {
        ...
        if(oSeries.getObjectType() === AscDFH.historyitem_type_ScatterSer && isHorizontalAxis(this)) {
            return oSeries.getCatSourceNumFormat();
        }
    ...
    CBarSeries.prototype.setShape = function(pr) {
        History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_BarSeries_SetShape, this.shape, pr));
        this.shape = pr;
    };
    ...
    CDispUnits.prototype =
    {
        ...
        setParent: function(pr) {
            History.CanAddChanges() && History.Add(new CChangesDrawingsLong(this, AscDFH.historyitem_DispUnitsSetParent, this.parent, pr));
            this.parent = pr;
        },
    ...
    CLayout.prototype =
    {
        ...
        setParent: function(pr) {
            History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_Layout_SetParent, this.parent, pr));
            this.parent = pr;
        },
    ...
    CChartRefBase.prototype = Object.create(AscFormat.CBaseObject.prototype);
    CChartRefBase.prototype.constructor = CChartRefBase;
    ...
    CChartRefBase.prototype.setParent = function(pr) {
        History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_CommonChartFormat_SetParent, this.parent, pr));
        this.parent = pr;
    };
    ...
    CChartRefBase.prototype.handleRemoveWorksheets = function(oRangeFrom, oRangeTo) {
        //TODO
    };
    ...
    CMultiLvlStrRef.prototype = Object.create(CChartRefBase.prototype);
    CMultiLvlStrRef.prototype.constructor = CMultiLvlStrRef;
    CMultiLvlStrRef.prototype.getObjectType = function() {
        return AscDFH.historyitem_type_MultiLvlStrRef;
    };
    CMultiLvlStrRef.prototype.createDuplicate = function() {
    ...
    CNumRef.prototype = Object.create(CChartRefBase.prototype);
    CNumRef.prototype.constructor = CNumRef;
    CNumRef.prototype.createDuplicate = function() {
        var c = new CNumRef();
        c.setF(this.f);
        if(this.numCache) {
    ...
    CNumRef.prototype.getObjectType = function() {
    ...
    CStrRef.prototype = Object.create(CChartRefBase.prototype);
    CStrRef.prototype.constructor = CStrRef;
    CStrRef.prototype.createDuplicate = function() {
        var c = new CStrRef();
        c.setF(this.f);
        if(this.strCache) {
    ...
    CStrRef.prototype.getObjectType = function() {
    ...
    CPictureOptions.prototype =
    {
        ...
        setApplyToEnd: function(pr) {
            History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_PictureOptions_SetApplyToEnd, this.applyToEnd, pr));
            this.applyToEnd = pr;
        },
        setApplyToFront: function(pr) {
            History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_PictureOptions_SetApplyToFront, this.applyToFront, pr));
            this.applyToFront = pr;
        },
        setApplyToSides: function(pr) {
            History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_PictureOptions_SetApplyToSides, this.applyToSides, pr));
    ...
    CScaling.prototype =
    {
        ...
        setParent: function(pr) {
            History.CanAddChanges() && History.Add(new CChangesDrawingsObject(this, AscDFH.historyitem_Scaling_SetParent, this.parent, pr));
            this.parent = pr;
        },
    ...
    CCat.prototype.setMultiLvlStrRef = function(pr) {
        ...
        if(this.multiLvlStrRef) {
            this.multiLvlStrRef.setParent(this);
        }
    };
    ...
    CChart.prototype = Object.create(AscFormat.CBaseObject.prototype);
    CChart.prototype.constructor = CChart;
