...
{
	let strTemp = "";
	let strNumerator = this.getNumerator().GetMultipleContentForGetText(isLaTeX, true);
	let strDenominator = this.getDenominator().GetMultipleContentForGetText(isLaTeX, true);
