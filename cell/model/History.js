...
// Frozen cell
	...
	window['AscCH'].historyitem_PivotTable_AddPageField = 15;
	window['AscCH'].historyitem_PivotTable_AddRowField = 16;
	window['AscCH'].historyitem_PivotTable_AddColField = 17;
	window['AscCH'].historyitem_PivotTable_AddDataField = 18;
	window['AscCH'].historyitem_PivotTable_RemovePageField = 19;
	window['AscCH'].historyitem_PivotTable_RemoveRowField = 20;
	window['AscCH'].historyitem_PivotTable_RemoveColField = 21;
	window['AscCH'].historyitem_PivotTable_RemoveDataField = 22;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetName = 23;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetOutline = 24;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetCompact = 25;
	window['AscCH'].historyitem_PivotTable_PivotFieldFillDownLabelsDefault = 26;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetInsertBlankRow = 27;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetDefaultSubtotal = 28;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetSubtotalTop = 29;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetShowAll = 30;
	window['AscCH'].historyitem_PivotTable_PivotFieldSetSubtotals = 31;
	window['AscCH'].historyitem_PivotTable_DataFieldSetName = 32;
	window['AscCH'].historyitem_PivotTable_DataFieldSetSubtotal = 33;
