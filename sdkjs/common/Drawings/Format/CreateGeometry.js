...
function CreateGeometry(prst, oGeom){
    ...
    switch(prst){
        ...
        case 'wedgeEllipseCallout':{
            ...
            f.AddGuide('x1', 1, 'hc', 'dx1', '0');
            f.AddGuide('y1', 1, 'vc', 'dy1', '0');
            f.AddGuide('dxEdge', 7, 'wd2', 'pang');
            f.AddGuide('dyEdge', 12, 'hd2', 'pang');
            f.AddGuide('xEdge', 1, 'hc', 'dxEdge', '0');
            f.AddGuide('yEdge', 1, 'vc', 'dyEdge', '0');
            f.AddGuide('posHypo', 9, 'dxPos', 'dyPos', '0');
            f.AddGuide('elHypo', 9, 'dxEdge', 'dyEdge', '0');
            f.AddGuide('posOutside', 1, 'posHypo', '0', 'elHypo');
            f.AddGuide('xTip', 3, 'posOutside', 'xPos', 'xEdge');
            f.AddGuide('yTip', 3, 'posOutside', 'yPos', 'yEdge');
            ...
            f.AddCnx('0', 'l', 'vc');
            f.AddCnx('_3cd4', 'ir', 'it');
            f.AddCnx('pang', 'xTip', 'yTip');
            f.AddRect('il', 'it', 'ir', 'ib');
            f.AddPathCommand(0,undefined, undefined, undefined, undefined, undefined);
            f.AddPathCommand(1, 'xTip', 'yTip');
            f.AddPathCommand(2, 'x1', 'y1');
        ...
        case 'wedgeRectCallout':{
            ...
            f.AddGuide('y2', 0, 'h', 'yg2', '12');
		        f.AddGuide('lTemp', 1, 'xPos', '0', 'l');
		        f.AddGuide('lComp', 3, 'lTemp', 'l', 'xPos');
            f.AddGuide('t1', 3, 'dxPos', 'l', 'lComp');
            f.AddGuide('xl', 3, 'dz', 'l', 't1');
            f.AddGuide('t2', 3, 'dyPos', 'x1', 'xPos');
            f.AddGuide('xt', 3, 'dz', 't2', 'x1');
		        f.AddGuide('rTemp', 1, 'xPos', '0', 'r');
		        f.AddGuide('rComp', 3, 'rTemp', 'xPos', 'r');
            f.AddGuide('t3', 3, 'dxPos', 'rComp', 'r');
            ...
            f.AddGuide('yl', 3, 'dz', 'y1', 't5');
	          f.AddGuide('tTemp', 1, 'yPos', '0', 't');
	          f.AddGuide('tComp', 3, 'tTemp', 't', 'yPos');
            f.AddGuide('t6', 3, 'dyPos', 't', 'tComp');
            f.AddGuide('yt', 3, 'dz', 't6', 't');
            f.AddGuide('t7', 3, 'dxPos', 'yPos', 'y1');
            f.AddGuide('yr', 3, 'dz', 'y1', 't7');
		        f.AddGuide('bTemp', 1, 'yPos', '0', 'b');
		        f.AddGuide('bComp', 3, 'bTemp', 'yPos', 'b');
            f.AddGuide('t8', 3, 'dyPos', 'bComp', 'b');
