...
$(function () {
	...
	let one = new ParaMath();
	p1.AddToContent(0, one);
	...
	QUnit.module("Unit-tests for CMathContent.Process_AutoCorrect");

	QUnit.test("Test:", function (assert)
	{
		AddText("2_1 ");
		let str = Root.GetTextOfElement(false);
		let CurPos = Root.CurPos;
		assert.strictEqual(str, "2_(1)", "Check content of degree");
		assert.strictEqual(CurPos, 2, "Check cursor position after proceed degree");
	})
});
