        ...
        initialize : function (options) {
            ...
            this.template = options.template || [
                    '<div class="box">',
                        ...
                        '<% } else if (type=="sheet") { %>',
                            '<div class="" style="margin-bottom: 10px; display: none">',
                                '<label>' + (t.txtSheetDescription + ' ' +  t.txtAllowDescription) + '</label>',
                            '</div>',
                            '<button type="button" class="btn btn-text-default auto" id="' + t.winId + '-id-range-btn-allow" style="min-width: 100px;margin-bottom: 15px;display:none">' + t.txtAllowRanges + '</button>',
                        '<% } else { %>',
                        ...
                        '<% } %>',
                        '<% if (type=="sheet") { %>',
                        '<table cols="2" style="width: 100%; display: none">', // CryptPad: Hide password since we did not implement this feature
                            '<tr>',
