        ...
        var template =
            '<section class="panel" data-tab="view" role="tabpanel" aria-labelledby="view">' +
                ...
                '<div class="group small">' +
                    ...
                    '</div>' +
                '</div>' +
                '<div class="separator long macro" style="display: none"></div>' + // CryptPad: Hide Macros because there are broken because of CryptPads security
                '<div class="group macro" style="display: none">' + // CryptPad: Hide Macros because there are broken because of CryptPads security
