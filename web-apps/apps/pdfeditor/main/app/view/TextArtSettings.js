...
define([
    'text!pdfeditor/main/app/template/TextArtSettings.template',
    'jquery',
    'underscore',
    'backbone',
    ...
    PDFE.Views.TextArtSettings = Backbone.View.extend(_.extend({
        ...
        initialize: function () {
            ...
            PDFE.getCollection('Common.Collections.TextArt').bind({
        ...
        setApi: function(api) {
            this.api = api;
            if (this.api) {
                this.api.SetInterfaceDrawImagePlaceTextArt && this.api.SetInterfaceDrawImagePlaceTextArt('textart-texture-img');
                        ...
                        if (me.api) {
                            ...
                            if (!_.isEmpty(checkUrl)) {
                                if (me.BlipFillType !== null) {
                                    ...
                                    me.api.ShapeApply(me.shapeprops);
                                }
                            }
                        }
                    }
...
//                        allowSelected : false,
        ...
        fillTextArt: function() {
            ...
            if (models.length<1) {
                PDFE.getController('Main').fillTextArt(this.api.asc_getTextArtPreviews());
                return;
            }
